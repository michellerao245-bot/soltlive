...
const AdBanner = ({ ad, onClose }) => {
  ...
  return (
    <div className="relative bg-[#131722] border border-gray-800 rounded-xl overflow-hidden mb-4 group">
      ...
      {/* 🌟 Permanent Top Navigation for New Users */}
      ...
      <div className="flex flex-col p-4 space-y-3">
        ...
        <div className="flex items-start gap-3">
          {/* Logo / Media Box */}
          <div className="w-16 h-16 bg-gradient-to-br from-purple-600/20 to-blue-600/20 border border-purple-500/20 rounded-lg flex-shrink-0 flex items-center justify-center overflow-hidden">
            {ad.bannerPreview ? (
              <img
                src={ad.bannerPreview}
                alt={ad.projectName || "Ad"}
          ...
          <div className="flex-1 min-w-0">
            <h4 className="text-white font-bold text-sm truncate">
              {ad.projectName || ad.project_name || "New Project"}
            </h4>
            <p className="text-gray-400 text-xs mt-1 line-clamp-3 leading-relaxed">
              {ad.description || "Click visit to check this premium cryptocurrency project."}
            </p>
          </div>
        </div>
